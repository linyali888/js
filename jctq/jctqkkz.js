...
#看看赚
https://tq.xunsl.com/v5/nameless/adlickstart.json 重写目标 https://raw.githubusercontent.com/linyali888/js/jctq/jctqkkz.js
[MITM]
...
function openbox(id,jctq_cookie1,timeout=0) {
    return new Promise((resolve) => {
        let url = {
            url : 'https://tq.xunsl.com/WebApi/Nameless/getBoxReward?id='+ id + '&' + jctq_cookie1,
            headers : {
    'Host': 'tq.xunsl.com',
     //'Referer': 'https://tq.xunsl.com/h5/20190527watchMoney/?' +jctq_cookie1
     'Referer':'https://tq.xunsl.com/h5/20190527watchMoney/?keyword_wyq=woyaoq.com&access=WIFI&app-version=8.1.2&app_version=8.1.2&carrier=%E4%B8%AD%E5%9B%BD%E7%A7%BB%E5%8A%A8&channel=c1005&'+jctq_cookie1},
            }
